...
class TestAgentSpec:
    ...
    def test_valid_spec_creation(self):
        ...
        spec = AgentSpec(
            api_version="v1",
            kind="Agent",
            metadata={"name": "test_agent", "version": "1.0.0", "tags": ["test"]},
            spec={
                "model_policy": {"preferred": {"provider": "ollama", "model": "qwen2.5-coder"}},
                "prompts": {"system": "test_prompt.md"},
    ...
    def test_spec_serialization(self):
        ...
        spec = AgentSpec(
            ...
            spec={
                "model_policy": {"preferred": {"provider": "ollama", "model": "test"}},
...
class TestLocalRuntime:
    ...
    def test_run_with_tool(self, mock_load):
        ...
        mock_load.return_value = {
            ...
            "spec": {
                "tools": [{"type": "python", "entrypoint": "test_tool.py:test_func"}],
                "model_policy": {"preferred": {"provider": "ollama", "model": "test"}},
                "prompts": {"system": "test.md"},
                "runtime": {"supported": ["local"]},
            },
...
class TestAgentExecution:
    ...
    def test_hello_world_agent(self):
        ...
        result = runtime.run(
            spec_path="agents/specs/examples/hello_world.agent.yaml", user_input="Hello!"
        )
    ...
    def test_agent_with_real_llm(self):
        ...
        runtime = LocalRuntime()
        result = runtime.run(spec_path="agents/specs/test_agent.yaml", user_input="What is 2+2?")
...
class TestPerformance:
    ...
    def test_agent_execution_time(self):
        ...
        result = runtime.run("agents/specs/test_agent.agent.yaml", "test input")
    ...
    def test_throughput(self):
        ...
        for i in range(num_requests):
            runtime.run("agents/specs/test_agent.agent.yaml", f"test input {i}")
...
class TestLoadTesting:
    ...
    def test_concurrent_execution(self):
        ...
        def execute_agent(index):
            return runtime.run("agents/specs/test_agent.agent.yaml", f"test input {index}")
...
@pytest.mark.parametrize(
    "input_data,expected", [({"age": 30}, 2), ({"age": 25}, 1), ({"age": 35}, 0)]
)
