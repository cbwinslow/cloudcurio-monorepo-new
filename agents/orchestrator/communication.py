...
class AgentMessage:
    ...
    task_id: str | None = None  # Optional ID to link messages to a task
...
def send_message(channel, message: AgentMessage, exchange: str, routing_key: str = ""):
    ...
    print(
        f" [x] Sent '{message.message_type}' to exchange '{exchange}' with routing key '{routing_key}'"
    )
