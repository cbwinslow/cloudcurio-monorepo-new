    ...
    def _initialize_tools(self) -> dict[str, AgentTool]:
        ...
        return {
            ...
            "voice_enhancement": AudioEngineerAgentTool(
                "voice_enhancement", "Enhance vocal clarity and presence", VoiceEnhancementTool()
            ),
            ...
            "audio_mastering": AudioEngineerAgentTool(
                "audio_mastering", "Master final audio for distribution", AudioMasteringTool()
            ),
            "normalize_audio": AudioEngineerAgentTool(
                "normalize_audio", "Normalize audio levels to target LUFS", AudioNormalizationTool()
            ),
            "extract_audio": AudioEngineerAgentTool(
                "extract_audio", "Extract audio track from video file", AudioExtractionTool()
            ),
        }
...
class AudioCleanupTool(RobustTool):
    ...
    def __init__(self):
        super().__init__(
            name="audio_cleanup", description="Remove background noise, hum, and unwanted artifacts"
        )
    ...
    def _define_validation_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "output_audio": {"type": "string", "description": "Path for output cleaned audio"},
...
class VoiceEnhancementTool(RobustTool):
    ...
    def __init__(self):
        super().__init__(name="voice_enhancement", description="Enhance vocal clarity and presence")
    ...
    def _define_validation_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "input_audio": {"type": "string", "description": "Path to input audio file"},
                "output_audio": {"type": "string", "description": "Path for output enhanced audio"},
                "preset": {
                    "type": "string",
...
class SponsorInsertionTool(RobustTool):
    ...
    def __init__(self):
        super().__init__(
            name="sponsor_insertion", description="Insert sponsor reads at optimal points"
        )
    ...
    def _define_validation_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "main_audio": {"type": "string", "description": "Path to main audio file"},
                "sponsor_audio": {
                    "type": "string",
                    "description": "Path to sponsor read audio file",
                },
                "output_audio": {"type": "string", "description": "Path for output combined audio"},
                "insertion_point": {
                    "type": "number",
    ...
    def _execute_core(self, parameters: dict[str, Any], execution_id: str) -> Any:
        ...
        if transition_style == "hard_cut":
            ...
            cmd = [
                ...
                sponsor_audio,
                "-filter_complex",
                f"[0:a]atrim=0:{insertion_point}[pre];[pre][1:a]concat=n=2:v=0:a=1[out]",
                "-map",
                "[out]",
                "-c:a",
                "pcm_s16le",
            ...
            cmd = [
                ...
                sponsor_audio,
                "-filter_complex",
                f"[0:a]atrim=0:{insertion_point},afade=t=out:d={fade_duration}[pre];[1:a]afade=t=in:d={fade_duration}[sponsor];[pre][sponsor]concat=n=2:v=0:a=1[out]",
                "-map",
                "[out]",
                "-c:a",
                "pcm_s16le",
            ...
            cmd = [
                ...
                sponsor_audio,
                "-filter_complex",
                f"[0:a]atrim=0:{insertion_point}[pre];[1:a]atrim=0:{sponsor_duration}[sponsor];[pre][sponsor]acrossfade=d={fade_duration}[out]",
                "-map",
                "[out]",
                "-c:a",
                "pcm_s16le",
...
class AudioMasteringTool(RobustTool):
    ...
    def __init__(self):
        super().__init__(name="audio_mastering", description="Master final audio for distribution")
    ...
    def _define_validation_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "input_audio": {"type": "string", "description": "Path to input audio file"},
                "output_audio": {"type": "string", "description": "Path for output mastered audio"},
                "target_lufs": {
                    "type": "number",
                    "default": -16,
    ...
    def _fallback_generic_mastering(
        self, error: Exception, parameters: dict[str, Any], execution_id: str
    ) -> ToolResult:
...
class AudioNormalizationTool(RobustTool):
    ...
    def __init__(self):
        super().__init__(
            name="normalize_audio", description="Normalize audio levels to target LUFS"
        )
...
class AudioExtractionTool(RobustTool):
    ...
    def _define_validation_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "output_audio": {"type": "string", "description": "Path for output audio file"},
                "format": {
                    "type": "string",
    ...
    def _execute_core(self, parameters: dict[str, Any], execution_id: str) -> Any:
        ...
        codec_map = {"mp3": "libmp3lame", "wav": "pcm_s16le", "aac": "aac", "flac": "flac"}
        ...
        cmd = [
            ...
            str(sample_rate),
            "-ab",
            bitrate if format_type != "wav" else None,
            output_audio,
        ]
