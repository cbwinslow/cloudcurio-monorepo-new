...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("logs/monitoring_agent.log"), logging.StreamHandler()],
)
...
class MonitoringAgent:
    ...
    def check_network_traffic(self) -> dict[str, dict]:
        ...
        for interface in self.config.get("network_interfaces", []):
            ...
            results[interface] = {"rx_bytes": 0, "tx_bytes": 0, "rx_packets": 0, "tx_packets": 0}
    ...
    def check_system_health(self) -> dict[str, dict]:
        ...
        for metric in self.config.get("system_metrics", []):
            ...
            results[metric] = {"status": "unknown", "value": "unknown"}
