...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("logs/diagnostic_agent.log"), logging.StreamHandler()],
)
...
class DiagnosticAgent:
    ...
    def check_file_consistency(self) -> dict[str, list[str]]:
        ...
        results = {"missing_files": [], "inconsistent_files": [], "outdated_files": []}
    ...
    def check_doc_completeness(self) -> dict[str, list[str]]:
        ...
        results = {"missing_docs": [], "incomplete_docs": []}
    ...
    def check_script_alignment(self) -> dict[str, list[str]]:
        ...
        results = {"missing_scripts": [], "unaligned_scripts": []}
